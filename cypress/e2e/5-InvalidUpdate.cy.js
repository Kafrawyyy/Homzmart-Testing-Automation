it (" UPDATE KSA Last name ensurring error handling" , ()=>{
    ...
    cy.get('.menu__list > :nth-child(1) > :nth-child(1) > .userMenu__link')
      .click()
    // enter new invalid last name
    cy.get('[data-v-9ebf2ce9=""][placeholder="ادخل الاسم الاخير"] > input')
...
it (" UPDATE EG last name ensurring error handling" , ()=>{
    ...
    // enter new invalid last name
    cy.get('[data-v-9ebf2ce9=""][placeholder="ادخل الاسم الاخير"] > input')
      .type('djcsdhdsjkchsdjfhsdjfkhdskjfhshfsdjfdgdhfkjdshfkjdshfjdshkjdshfdshdjf')
    // see error message
    cy.get('.app-alert')
      .should('be.visible')
